 ...
 * @see:http://blog.csdn.net/softwave/article/details/12838045
 * @DateTime: 2015年10月6日下午1:44:58
 * @Version: 1.0.0
...
public class EncryptUtil {  
    ...
    public String encrypt(String strIn)  {  
    	String value ="";
    			try {
					value=byteArr2HexStr(encrypt(strIn.getBytes()));
				} catch (Exception e) {
				}
        return value;  
    }  
    ...
    public String decrypt(String strIn)  { 
    	String r = "";
		try {
			r = new String(decrypt(hexStr2ByteArr(strIn)));
		} catch (Exception e) {
		}
        return r;  
    }  
    ...
    public static void main(String[] args) {  
        try {  
            String test1 = "你好你爱爱哪里呢你好你爱爱哪里呢你好你爱爱哪里呢你好你爱爱哪里呢你好你爱爱哪里呢你好你爱爱哪里呢你好你爱爱哪里呢你好你爱爱哪里呢你好你爱爱哪里呢你好你爱爱哪里呢你好你爱爱哪里呢";  
            ...
            String test2 = "你好你在哪里呢";  
            EncryptUtil des2 = new EncryptUtil("leeme32nz");// 自定义密钥  
