...
//        head4 = phoneNum.substring(0, 4);
     ...
     * @param reqObj
     */
    public static void reqStrParasCheck(String reqStr){
      objCheck(reqStr);
      if("".equals(((String) reqStr).trim())){
        writeObjIsNullExcepLog(reqStr,"reqObj");
      }
    }
    /**
     * 请求字符串参数合法性检查
     * @param reqObj
     */
    public static void reqStrParasCheck(String reqStr,String msg){
      objCheck(reqStr,msg);
      if("".equals(((String) reqStr).trim())){
        writeObjIsNullExcepLog(reqStr,msg);
      }
    }
    /**
     * 请求BigDecimal参数合法性检查
     * @param reqObj
     */
    public static void reqBigDecimalParasCheck(BigDecimal reqBigDecimal){
      objCheck(reqBigDecimal);
      if(((BigDecimal)reqBigDecimal).compareTo(BigDecimal.ZERO) != 1){
        throw new RuntimeException("传入对象值应该大于0");
      }
    }
    /**
     * 请求Integer参数合法性检查
     * @param reqObj
     */
    public static void reqIntegerParasCheck(Integer reqInt){
      objCheck(reqInt);
      if(reqInt == 0){
        writeObjIsNullExcepLog(reqInt,"reqObj");
      }
    }
    /**
     * 请求Long参数合法性检查
     * @param reqObj
     */
    public static void reqLongParasCheck(Long reqLong){
      objCheck(reqLong);
      if(reqLong == 0l){
        writeObjIsNullExcepLog(reqLong,"reqObj");
      }
    }
    /**
     * 对象非空判断
     ...
     * @return
     */
    public static void objCheck(Object o){
      if(null == o){
        writeObjIsNullExcepLog(o,"o");
      }
    }
    /**
     * 对象非空判断
     ...
     * @return
     */
    public static void objCheck(Object o,String msg){
      if(null == o){
        writeObjIsNullExcepLog(o,msg);
      }
    }
    /**
     * 写传入对象为空日志并抛出异常
     ...
     * @author zhaoyongping
     */
    protected static void writeObjIsNullExcepLog(Object obj,String objNm){
      if(null == obj){
          logger.error("传入对象为空");
     ...
     * @author zhaoyongping
     */
    protected static void writeCatchExcepLog(Exception e,String msg){
     ...
     * @return
     */
    protected <T> List<T> convertCollection2List(Collection<T> collections){
